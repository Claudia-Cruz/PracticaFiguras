...
public class Triangulo extends Figura {
    ...
    public void CalcularAngulos()
    {
        ...
        this._lado_a=Math.acos(anguloA*(180/Math.PI));
        ...
        this._lado_b=Math.acos(anguloB*(180/Math.PI));
        System.out.println("Angulo B: "+this._angulo_b);

        double anguloC= (Math.pow(this._lado_a,2)-Math.pow(this._lado_b,2)-Math.pow(this._lado_c,2))/(-2*this._lado_a*this._lado_b);
        this._lado_a=Math.acos(anguloA*(180/Math.PI));
